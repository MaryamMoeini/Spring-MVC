				...
				<div class="board">
					...
					<div class="tab-content">
						<div class="tab-pane fade in active" id="home">
						   <h1 style="margin-left: 20px;">Multiple Choice Question</h1>
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
								 	<form:input type="file" path="img1" class="form-control" name="img1" id="img1"/>
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-4">
								 	<form:input type="file" path="img2" class="form-control" name="img2" id="img2"/>
								</div>
							</div>
