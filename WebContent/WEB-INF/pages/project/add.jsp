				...
				<div class="board">
					...
					<div class="board-inner">
						<ul class="nav nav-tabs" id="myTab">
							...
							<li><a href="<c:url value='/project/list' />" data-toggle="tab" title="profile" >
						...
						<div class="tab-pane fade in active" id="home">
							<form:form class="form-horizontal" role="form"
								...
								<div class="form-group">
									...
									<div class="col-sm-4">
										<form:input type="title" class="form-control" id="title"
											...
											value="${project.title}" maxlength="20"/>
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group">
									...
									<div class="col-sm-4">
										<form:input type="author" class="form-control" id="author"
											placeholder="Enter author" path="author"
											value="${pageContext.request.userPrincipal.name}" maxlength="20"/>
									</div>
								</div>
								<div class="form-group">
